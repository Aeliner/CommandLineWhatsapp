...
${OBJECTDIR}/DtArchivada.o: DtArchivada.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtArchivada.o DtArchivada.cpp
...
${OBJECTDIR}/DtControl.o: DtControl.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtControl.o DtControl.cpp

${OBJECTDIR}/DtConv.o: DtConv.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtConv.o DtConv.cpp

${OBJECTDIR}/DtDatoM.o: DtDatoM.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtDatoM.o DtDatoM.cpp
...
${OBJECTDIR}/DtParticipante.o: DtParticipante.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtParticipante.o DtParticipante.cpp

${OBJECTDIR}/DtPrivada.o: DtPrivada.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtPrivada.o DtPrivada.cpp
...
${OBJECTDIR}/DtUsuario.o: DtUsuario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtUsuario.o DtUsuario.cpp
...
${OBJECTDIR}/Est_Conv.o: Est_Conv.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Est_Conv.o Est_Conv.cpp
...
${OBJECTDIR}/Grupal.o: Grupal.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grupal.o Grupal.cpp
...
${OBJECTDIR}/Privada.o: Privada.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Privada.o Privada.cpp
...
${OBJECTDIR}/Usu_Grupo.o: Usu_Grupo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Usu_Grupo.o Usu_Grupo.cpp
...
${OBJECTDIR}/ctrlConv.o: ctrlConv.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ctrlConv.o ctrlConv.cpp

${OBJECTDIR}/ctrlFecha.o: ctrlFecha.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ctrlFecha.o ctrlFecha.cpp

${OBJECTDIR}/ctrlGrupo.o: ctrlGrupo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ctrlGrupo.o ctrlGrupo.cpp

${OBJECTDIR}/ctrlUsuario.o: ctrlUsuario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ctrlUsuario.o ctrlUsuario.cpp

${OBJECTDIR}/iConv.o: iConv.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iConv.o iConv.cpp

${OBJECTDIR}/iFecha.o: iFecha.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iFecha.o iFecha.cpp

${OBJECTDIR}/iGrupo.o: iGrupo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iGrupo.o iGrupo.cpp

${OBJECTDIR}/iUsuario.o: iUsuario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iUsuario.o iUsuario.cpp
